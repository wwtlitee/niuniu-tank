...
test('endless wave count is bounded even far into the run',()=>{const S=require('../js/survival-system.js');assert.equal(S.waveProfile(100).count,1000);assert.ok(Number.isFinite(S.waveProfile(10000).hpMultiplier));});
